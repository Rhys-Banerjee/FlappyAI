"""
FlappyBird, but with NEAT algorithm to produce perfect game play. Created following tutorial by YouTuber, Tech With Tim.
First, FlappyBird recreated using PyGame, then deep learning implemented using neat module for Python.
The purpose of this exercise was to increase my understanding in machine learning principles while reaffirming my confidence in Python.

Date modified: 12/24/20
Modified by: Rhys Banerjee
